...
class LinearCohesiveZoneModel(CohesiveZoneModelBase):
    ...
    def compute_cohesive_force_in_model(self, current_disc_opening):
        """
        Calcule par une interpolation lin�aire la contrainte correspondant � l'ouverture en argument
        ____
            \
             \
              _____
        :param current_disc_opening: ouverture de la discontinuit� � calculer
        :return: contrainte
        """
