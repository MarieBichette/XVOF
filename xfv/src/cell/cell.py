...
class Cell(object):
    ...
    def initialize_cell_fields(self, mask_node_target, mask_node_projectile, topology):
        """
        Initialisation des champs aux mailles et des caract�ristiques cell_in_target et cell_in_projectile
        ...
        # 1 pour ne pas prendre la derni�re maille du projectile qui est connect�e aussi � un noeud target
        # -1 pour ne pas prendre la maille connect�ee au dernier noeud de la cible, qui n'existe pas
        ...
        # on �limine les noeuds extr�mes :
        # -1 pour ne pas prendre la premi�re maille de la cible qui est aussi connect�e � un noeud projectile
        # 1 pour ne pas prendre la maille connect�ee au premier noeud du projectile, qui n'existe pas
        ...
        # (le mask est vide si pas de projectile donc transparent quand il n'y a pas de projectile d�clar�)
