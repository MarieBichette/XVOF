...
class TimeFigureManager:
    ...
    #     # Partie droite d�clar�e dans le init de figure manager
    ...
    #     """
    #     Ecrit dans le shell les r�sultats de l'erreur
    #     :param critere : float : critere de coloration des r�sultats (pour affichage en vert / rouge)
    #     """
    ...
    def plot_error_vs_time(self, field, compute_error_index, my_label=None, my_color=None,
        ...
        :param compute_error_index : entier qui d�finit la m�thode de calcul de l'erreur
