...
if not len(sys.argv) == 5:
    raise ValueError("Ce script attend comme  arguments  : "
                     "\n les champs � tracer (ex: PressureField, VelocityField, DensityField)"
                     "\n et une liste des cas � traiter"
                     " le type de donnees � �crire : profile ou evolution"
                     " une liste de temps � �crire pour 'profile' ou de item_id pour 'evolution'")
