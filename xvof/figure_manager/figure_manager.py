...
PressureField = Field("Pression [Pa]", "Champ de pression", 0, 7.5e+09, "./RESULTATS/PressureField")
DensityField = Field("Masse volumique [kg/m3]", "Champ de densite", 8000.0, 8500.0, "./RESULTATS/DensityField")
