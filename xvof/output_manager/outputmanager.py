...
class OutputManager(object):
    ...
    def register_all_fields(self, cells, nodes, database_id, cell_indexes=None, node_indexes=None):
        ...
        self.register_field("CellLeftSize", cells, ("left_size", "current_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("CellRightSize", cells, ("right_size", "current_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("ClassicalPressure", cells, ("pressure", "current_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("EnrichedPressure", cells, ("pressure", "current_enr_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("ClassicalDensity", cells, ("density", "current_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("EnrichedDensity", cells, ("density", "current_enr_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("ClassicalInternalEnergy", cells, ("energy", "current_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("EnrichedInternalEnergy", cells, ("energy", "current_enr_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("ClassicalSoundVelocity", cells, ("sound_velocity", "current_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("EnrichedSoundVelocity", cells, ("sound_velocity", "current_enr_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("ClassicalArtificialViscosity", cells, ("pseudo", "current_value"), database_names=[database_id], indexes=cell_indexes)
        self.register_field("EnrichedArtificialViscosity", cells, ("pseudo", "current_enr_value"), database_names=[database_id], indexes=cell_indexes)
